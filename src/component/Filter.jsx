    ...
    <div className="flex items-center justify-between">
      <div className="relative">
        ...
        <input
          ...
          className="w-[248px] h-[40px] px-[16px] py-[10px] placeholder:text-[#999] placeholder:text-[14px] plcaeholder:font-[400px] bg-white border border-[#] rounded-md pl-9 pe-10 sm:text-sm"
        />
      ...
      <div className="flex gap-[12px]">
        <div className="cursor-pointer flex gap-1.5 justify-center items-center px-[12px] py-[6px] rounded-[4px] border border-solid border-[#D9D9D9]">
          <p className="flex items-center font-[400px] text-[16px] h-[24px] text-[#4D4D4D]">
            Sort
          </p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="cursor-pointer flex items-center justify-center rounded-[4px] border border-solid border-[#D9D9D9] h-[36px] w-[36px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
